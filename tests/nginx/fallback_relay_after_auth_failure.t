...
my $first = ('x' x 22) . ' first frame';
my $second = ' second frame after fallback';
...
$client->write($second);
is($client->read(), $second,
    'auth failure fallback relays later client bytes on the same connection');
